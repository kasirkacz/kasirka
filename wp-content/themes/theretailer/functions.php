...
function theretailer_styles() {	
	...
	wp_enqueue_style('getbowtied_swiper_styles', get_template_directory_uri() . '/css/swiper.css', array(), '3.3.1', 'all' );
...
function theretailer_scripts() {  
	...
	wp_enqueue_script('getbowtied_swiper_scripts', get_template_directory_uri() . '/js/swiper.jquery.min.js', array('jquery'), '3.3.1', TRUE);
...
/******************************************************************************/
add_filter('woocommerce_add_to_cart_fragments', 'theretailer_shopping_bag_items_number');
function theretailer_shopping_bag_items_number( $fragments ) {
	global $woocommerce;
	ob_start(); ?>
