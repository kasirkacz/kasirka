        ...
        <div class="images">
            ...
            <?php
                if ( $product->get_image_id() ) {
                    ...
                    echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="Placeholder" />', wc_placeholder_img_src( 'woocommerce_single' ) ), $post->ID );
            ...
            <div class="images gbtr_images">
               ...
               <!-- <div class='doubleSlider-1'>-->
                    ...
                    <div id="sync1" class="slider product_images doubleSlider-1 woocommerce-product-gallery__wrapper<?php echo $slider_class; ?>">
                        ...
                        <?php echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="Placeholder" />', wc_placeholder_img_src( 'woocommerce_single' ) ), $post->ID );?>
					...
					<div class="product_thumbs_inner"> 
						<div  id="sync2" class = 'slider doubleSlider-2'>
									...
									foreach ( $attachment_ids as $attachment_id ) {
										...
										echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<div class="button">%s</div>', $image ), $attachment_id, $post->ID, $image_class ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped
